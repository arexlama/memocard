...
gb_answer = QGroupBox('Результат теста')

v1 = QVBoxLayout()

v1.addWidget(lb_result, alignment=Qt.AlignmentFlag.AlignTop)
v1.addStretch(1)
v1.addWidget(lb_right_answer, alignment=Qt.AlignmentFlag.AlignHCenter)
v1.addStretch(1)
