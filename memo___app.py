from PyQt5.QtWidgets import QApplication, QWidget, QLineEdit,\
       QHBoxLayout, QVBoxLayout, QPushButton, QLabel, QMessageBox
...
# stats_answers = f'Разів відповіли: {answers}'
# stats_got_right = f'Вірних відповідей: {answers_got_right}'
# stats_ratio = f'Успішність: {ratio:.2%}'
